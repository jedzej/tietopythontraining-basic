...
list_of_numbers[index_min], list_of_numbers[index_max] = \
    list_of_numbers[index_max], list_of_numbers[index_min]
print(' '.join(str(element) for element in list_of_numbers))
