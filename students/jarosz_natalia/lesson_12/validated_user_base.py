...
from lesson_08.postal_code_validator\
    import postal_code as is_valid_postal_code
from lesson_08.strong_password_detection\
    import strong_password as is_strong_password
from lesson_08.phone_number_validator\
    import phone_number as is_valid_phone_number
from lesson_08.email_validator\
    import email_validator as is_valid_email
...
def main():
    ...
    email = input("Input email (e.g. test@mail.com): ")
    password = input("Input password (e.g. My_pass12!): ")
    phone_number = input("Input phone number (e.g. 123-456-789): ")
    postal_code = input("Input postal code (e.g. 50-433): ")
